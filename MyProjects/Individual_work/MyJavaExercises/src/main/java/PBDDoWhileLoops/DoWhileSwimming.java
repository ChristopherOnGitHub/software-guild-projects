...
//at 80.5f they swim the same amount of time
//if the water is too cold goofus dives in without checking water temperature
//goofus does this because he is in a do while loop 
//do whiles execute the code before checking the condition