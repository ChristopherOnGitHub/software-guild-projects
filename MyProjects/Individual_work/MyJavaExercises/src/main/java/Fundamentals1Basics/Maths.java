...
public class Maths {
    ...
    public static void main(String[]args){
        ...
        //Instructions show minus 4, needs changed
        ...
        System.out.print("44 minus 22 minus 11 minus 66 minus 88 minus 76 mins 11 minus 33 is: ");
        System.out.println(44 -22 - 11 - 66 - 88 - 76 - 11 - 33);
        
       
       //typo in next line(?) nothing given for subtraction after 6
        System.out.print("22 times 3 minus 1 plus 4 times 6 minus is: ");
        System.out.println(22 * 3 - 1 + 4 * 6);
        
        System.out.print("Is 67 greater than 4 * 5? ");
        System.out.println(67 > (4*5));
        
        //Furter error in example. than is repeated
