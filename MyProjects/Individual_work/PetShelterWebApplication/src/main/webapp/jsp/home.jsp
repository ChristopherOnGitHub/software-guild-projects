                ...
                <div class="col-md-6">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="add-pet-breed" name="petBreed" type="text" class="form-control" placeholder="Pet Breed" />
                            </div>    
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="add-pet-disposition" name="petDisposition" type="text" class="form-control" placeholder="Pet Disposition" />
                            </div>    
                        </div>
                    ...
                    <div id="validationErors" class="alert alert-danger" style="display:none"></div>
                </div>    
            </div>
        </div>
