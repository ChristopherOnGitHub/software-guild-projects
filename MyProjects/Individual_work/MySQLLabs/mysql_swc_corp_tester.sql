...
insert into Employee values(1,'Adams','Alex','01-1-1','001');
insert into Employee values(2,'Brown','Barry','02-8-12','001');
insert into Employee values(3,'Osako','Lee','99-9-1','002');
insert into Employee values(4,'Kennson','David','96-3-16','001');
insert into Employee values(5,'Bender','Eric','07-5-17','001');
insert into Employee values(6,'Kendall','Lisa','01-11-15','004');
insert into Employee values(7,'Lonning','David','00-1-1','001');
insert into Employee values(8,'Marshbank','John','01-11-15',null);
insert into Employee values(9,'Newton','James','03-9-30','002');
insert into Employee values(10,'O''Haire','Terry','04-10-4','002');
insert into Employee values(11,'Green','Sally','89-4-1','001');
insert into Employee values(12,'O''Neil','Barbara','95-5-26','004');

insert into Location values(1,'111 First AVE','Seattle', 'WA');
...
UPDATE Employee SET Status = 'Contractor' WHERE LocationID = 4;
...
UPDATE `Grant` INNER JOIN Employee ON `Grant`.EmpID = Employee.EmpID 
SET Amount = 20000 
WHERE Employee.LocationID = 2;