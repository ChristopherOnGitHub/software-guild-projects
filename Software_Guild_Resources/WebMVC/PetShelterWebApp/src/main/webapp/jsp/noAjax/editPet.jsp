        ...
        <div class="container">
            ...
            <div class="col-lg-offset-3 col-lg-6">
                ...
                <form action="/PetShelterWebApp/ajaxFree/edit" method="POST">
                    ...
                    Vaccinated: 
                    <input type="radio" name="vaccinated" value="si" <c:if test="${editThisPet.vaccinated}">checked="checked"</c:if>/>Yes 
                    <input type="radio" name="vaccinated" value="no" <c:if test="${!editThisPet.vaccinated}">checked="checked"</c:if>/>No<br/>
