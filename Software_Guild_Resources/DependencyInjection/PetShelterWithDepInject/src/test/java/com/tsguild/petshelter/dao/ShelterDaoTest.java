...
public class ShelterDaoTest {
     ...
     * Remove Pet: 
     * remove existing pet 
     * remove non-existent pet 
     * remove 'similar' pet 
     * remove existing pet twice
     *
     * Get All Pets 
     * 
     * never null 
     * empty list on empty 
     * list after add new matches size count + 1, and contains added pet 
     * list after 'replace' matches previous size count and contains replaced pet, not original 
     * list after add similar, matches prev size + 1, and contains both 'similar' 
     * list after remove 1 is decremented in size and does not contain removed 
     * list after remove nonexisting does not change 
     * list after remove twice only removes the one pet
     *
     * Get Pet 
     * get on non-existent returns null 
     * get after add new returns new pet 
     * get after pet replaced returns replaced pet 
     * get after add similar returns similar, not original 
     * get after a pet remove returns null 
     * get after a similar pet removed similar returns original 
     * get after a pet removed twice returns null
     * 
     */
    @Test
